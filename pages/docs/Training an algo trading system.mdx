...
both **RULES** and **PARAMETERS** so that the generated rules and the trained parameters are used. Example: **NumTrainCycles = 2;** 
...
results in WFO and in real trading.   
...
chaotic parameter performance chart.   
...
trades from different price curves with resampled bars.   
