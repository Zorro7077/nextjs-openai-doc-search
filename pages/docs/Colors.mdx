...
Colors can be defined as hexadecimal numbers just as in HTML pages, in the form **0xTTRRGGBB** (f.i. **0x000000FF** = opaque 

blue, **0x80FF0000** = half transparent red). The transparency **TT** runs from **0** (full opaque) over **80** (half transparent) to **FF** (full transparent). 

Some colors are 

predefined: **RED**, **GREEN**, **BLUE**, **CYAN**, **DARKBLUE**, **LIGHTBLUE**, **PU**

## RPLE, YELLOW, MAGENTA, ORANGE, DARKGREEN, OLIVE, MAROO N, SILVER, GREY, BLACK. +TRANSP can be added for 50% transparency. 

For generating color ranges dependent on a variable, use 
...
`  `**ColorEquity = 0x0000FF00; *// green equity bars*   ColorDD = 0; *// no underwater equity*** 
