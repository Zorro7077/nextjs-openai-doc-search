...
## string OutName = "History\\SPY\_2022.t8"; *// file to append to ![](Aspose.Words.bd6e3632-bd5b-4d9f-873c-e3c552074c5a.001.png)*
...
## C->fBid = dataVar(2,i,8); C->fVol = dataVar(2,i,10); C->fUnl = dataVar(2,i,5); 
...
`    `**int YYYY = Expiry-MMDD\*10000;     dataSet(1,i,7,YYYY\*10000+MMDD);   }** 
...
`  `**for(Year = 2014; Year <= 2019; Year++) {     dataNew(2,0,0);** 
